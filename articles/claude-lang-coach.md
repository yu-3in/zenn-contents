...
エンジニアとして英語の重要性は感じている。それなのに、アプリを入れても 3 ヶ月で辞める。年に一回「今年こそ」と思う。また辞める。このループに覚えがある人は多いんじゃないでしょうか。
...
ほしいのは英語教室じゃなくて、隣にネイティブの同僚がいて、自分の書いた文章をさりげなく直してくれる、そんな環境。考えてみれば、普段の開発で Claude Code に日本語や英語のテキストを毎日大量に打ち込んでいる。これをそのまま添削してもらえるようにすれば、それってもうネイティブの同僚が隣にいるのと同じなんじゃないか。
